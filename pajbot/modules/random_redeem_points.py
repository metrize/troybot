...
class RandomRedeem(BaseModule):
    ...
    SETTINGS = [
        ...
        ModuleSetting(key="lower_points", label="Lower bound number of points", type="number", required=True, default=10000),
        ModuleSetting(key="upper_points", label="Upper bound number of points", type="number", required=True, default=10000),
    ]
